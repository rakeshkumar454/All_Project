...
public class ShoppingController {
	...
	@GetMapping("/shopping-catalog/{productNumber}")
	public String invokeCatalogService(@PathVariable  Integer productNumber) {
		String url = "http://catalog-service/catalog-provider/show/"+productNumber;
		return restTemplate.getForObject(url, String.class);
	}
}
