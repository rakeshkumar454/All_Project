...
public class ProductService {
	...
	static List<Product> list = Arrays.asList(new Product(1, "Table", 900d, 102), new Product(2, "Chair", 1500d, 10),
	...
	public static void main(String[] args) {
		...
		while (quit) {
			...
			case 1:
				...
				if (found == false)
					System.out.println("No such product " + name + " found in the list");
				break;
			...
			case 2:
				...
				if (foundprice == false)
					System.out.println("No products available for the price " + price);
				break;
			case 3:
